...
class ChangeNameViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        navigationItem.title = NSLocalizedString("Change name", comment: "change_name_title")
        ...
        fieldOne = generateTextField(NSLocalizedString("Name", comment: "prompt_name"), keyboardType: .Default, secured: false, controller: self, onEndFunction: "fieldOneEndFunc")
        fieldOne.textField.text = PFUser.currentUser()!["name"] as? String
        fieldOne.textField.autocapitalizationType = .Words
    ...
    func saveFunc(){
        if fieldOne.textField.text!.isEmpty{
            UIAlertView.init(title: NSLocalizedString("Error", comment: "Error_title"), message: NSLocalizedString("Name field is required", comment: "prompt_name_required"), delegate: nil, cancelButtonTitle: NSLocalizedString("Ok", comment: "prompt_ok")).show()
        }else{
            PFUser.currentUser()!["name"] = fieldOne.textField.text
